...
# if the first parameter is a key in the third parameter, if it is, return True, 
# otherwise return False. But if the second paramtere is False, then the function 
# should check to see if the first parameter is not a key of the third. 
# If it’s not, the function should return True in this case, and if it is , it should 
# return False.
...
# and otherwise, it returns False. Follow the instructions in the active code window 
# for specific variable assignments.
...
fruit_ans = checkingIfIn('fruit', direction=False)
# Call the function using the first and third parameter so that the value 8 is assigned to the variable param_check
#param_check = checkingIfIn('apple' ) * checkingIfIn('apple
